...
const Solomon: React.FC = () => {
  ...
  const [contentDisplayDirection, setContentDisplayDirection] = useState(mediaQuery.matches ? "rows" : "columns");

  useEffect(() => {
    const handleMediaQueryChange = (e: MediaQueryListEvent) => {
      setContentDisplayDirection(e.matches ? "rows" : "columns");
    };
  ...
  const functionalities: FunctionalityCard[] = [
    {
      icon: (
        ...
        >
          {" "}
          <path
            d="M7 17.3903V8.39032H2.59961C2.03956 8.39032 1.75981 8.39032 1.5459 8.49931C1.35774 8.59519 1.20487 8.74818 1.10899 8.93634C1 9.15025 1 9.43024 1 9.9903V17.3903H7ZM7 17.3903H13M7 17.3903V2.9903C7 2.43024 7 2.15025 7.10899 1.93634C7.20487 1.74818 7.35774 1.59519 7.5459 1.49931C7.75981 1.39032 8.03956 1.39032 8.59961 1.39032H11.3996C11.9597 1.39032 12.2405 1.39032 12.4544 1.49931C12.6425 1.59519 12.7948 1.74818 12.8906 1.93634C12.9996 2.15025 13 2.43024 13 2.9903V17.3903M13 17.3903L19 17.3903V6.9903C19 6.43024 18.9996 6.15025 18.8906 5.93634C18.7948 5.74818 18.6425 5.59519 18.4544 5.49931C18.2405 5.39032 17.9601 5.39032 17.4 5.39032H13V17.3903Z"
            stroke="#5E71FE"
            strokeWidth="2"
            strokeLinecap="round"
    ...
    },
    {
      ...
      description: "Extract and verify informations from various sources",
    },
  ];
      ...
      {contentDisplayDirection === "columns" ? (
        <div className="solomonContent">
          <div className="leftColumn">
            <Title />
            <Functionalities functionalities={functionalities} contentDisplayDirection={contentDisplayDirection} />
          </div>
